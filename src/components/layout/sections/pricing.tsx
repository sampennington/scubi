...
const plans: PlanProps[] = [
  ...
  },
  {
    ...
    popular: 1,
    price: 29,
    description: "Perfect for dive shops ready to launch their professional online presence.",
  ...
  },
  {
    ...
    popular: 0,
    price: 49,
    description: "For established dive businesses needing advanced features and customization.",
...
export const PricingSection = () => {
  return (
    <section id="pricing" className="container mx-auto px-4 py-24 sm:py-32">
      <h2 className="mb-2 text-center text-lg text-primary tracking-wider">Affordable Pricing</h2>
      ...
      <h3 className="mx-auto pb-14 text-center text-muted-foreground text-xl md:w-1/2">
        Hosting, support, and updates included. Connect your own domain. Monthly or annual plans
        available.
      </h3>
