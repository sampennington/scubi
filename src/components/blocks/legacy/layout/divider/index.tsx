import type { DividerContent } from "../../shared/schemas"
import { defaultDividerContent } from "./defaults"

export const DividerBlock = ({ content = defaultDividerContent }: { content?: DividerContent }) => {
