    ...
    sections: [
      {
        ...
        fields: [
          ...
          },
          {
            ...
            rows: 3,
            maxLength: 300,
            defaultValue: "Aliquet nec orci mattis amet quisque ullamcorper neque, nibh sem. At arcu, sit dui mi, nibh dui, diam eget aliquam. Quisque id at vitae feugiat egestas."
          }
        ]
      },
      {
        ...
        fields: [
          {
            ...
            accept: "image/*",
            aspectRatio: "4/3",
            defaultValue: "https://tailwindcss.com/plus-assets/img/component-images/dark-project-app-screenshot.png"
          },
          {
            type: "text",
            name: "imageAlt", 
        ...
        fields: [
          {
            ...
            rows: 4,
            maxLength: 500,
            defaultValue: "Faucibus commodo massa rhoncus, volutpat. Dignissim sed eget risus enim. Mattis mauris semper sed amet vitae sed turpis id. Id dolor praesent donec est. Odio penatibus risus viverra tellus varius sit neque erat velit."
          }
        ]
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            rows: 3,
            maxLength: 400,
            defaultValue: "Id orci tellus laoreet id ac. Dolor, aenean leo, ac etiam consequat in. Convallis arcu ipsum urna nibh. Pharetra, euismod vitae interdum mauris enim, consequat vulputate nibh."
          }
        ]
      }
    ]
